    ...
    protected VoxelShape getShape(BlockState state, BlockGetter level, BlockPos pos, CollisionContext context) {
        ...
        return switch (state.getValue(FACE)) {
            case FLOOR -> direction.getAxis() == Direction.Axis.X
                    ? (pressed ? FLOOR_X_PRESSED_SHAPE : FLOOR_X_SHAPE)
                    : (pressed ? FLOOR_Z_PRESSED_SHAPE : FLOOR_Z_SHAPE);
            ...
            case CEILING -> direction.getAxis() == Direction.Axis.X
                    ? (pressed ? CEILING_X_PRESSED_SHAPE : CEILING_X_SHAPE)
                    : (pressed ? CEILING_Z_PRESSED_SHAPE : CEILING_Z_SHAPE);
        };
    }
