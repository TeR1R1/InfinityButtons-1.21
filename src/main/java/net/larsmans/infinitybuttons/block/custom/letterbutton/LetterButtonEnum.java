...
public enum LetterButtonEnum implements StringRepresentable {
    ...
    DOT("dot"), COMMA("comma"), Q_MARK("q_mark"), EX_MARK("ex_mark"), MINUS("minus"), PLUS("plus"), COLON("colon"),
    EQUALS("equals"), HASHTAG("hashtag"), BRACKET_OPEN("br_open"), BRACKET_CLOSE("br_close"), SLASH("slash");
