...
public class DeepslateTileSecretButton extends AbstractSecretButton {
    ...
    public MapCodec<? extends HorizontalDirectionalBlock> codec() {
        return simpleCodec(p -> new DeepslateTileSecretButton(p, Blocks.DEEPSLATE_TILES));
    }
    public DeepslateTileSecretButton(BlockBehaviour.Properties properties, Block jadeBlock) {
        super (
                properties,
                Shapes.or(BASE,
